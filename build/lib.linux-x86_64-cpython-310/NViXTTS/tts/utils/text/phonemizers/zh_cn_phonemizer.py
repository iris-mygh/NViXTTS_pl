...
from NViXTTS.tts.utils.text.chinese_mandarin.phonemizer import chinese_text_to_phonemes
...
class ZH_CN_Phonemizer(BasePhonemizer):
    """🐸TTS Zh-Cn phonemizer using functions in `NViXTTS.tts.utils.text.chinese_mandarin.phonemizer`
