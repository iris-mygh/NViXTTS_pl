...
from NViXTTS.tts.utils.text.japanese.phonemizer import japanese_text_to_phonemes
...
class JA_JP_Phonemizer(BasePhonemizer):
    """🐸TTS Ja-Jp phonemizer using functions in `NViXTTS.tts.utils.text.japanese.phonemizer`

    TODO: someone with JA knowledge should check this implementation

    Example:

        >>> from NViXTTS.tts.utils.text.phonemizers import JA_JP_Phonemizer
