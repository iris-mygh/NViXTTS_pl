...
from NViXTTS.tts.layers.bark.inference_funcs import (
    codec_decode,
    generate_coarse,
    generate_fine,
...
from NViXTTS.tts.layers.bark.load_model import load_model
from NViXTTS.tts.layers.bark.model import GPT
from NViXTTS.tts.layers.bark.model_fine import FineGPT
...
class Bark(BaseTTS):
    ...
    def synthesize(
        ...
        Args:
            ...
            **kwargs: Model specific inference settings used by `generate_audio()` and `NViXTTS.tts.layers.bark.inference_funcs.generate_text_semantic().
