...
from NViXTTS.tts.layers.align_tts.mdn import MDNBlock
from NViXTTS.tts.layers.feed_forward.decoder import Decoder
from NViXTTS.tts.layers.feed_forward.duration_predictor import DurationPredictor
...
from NViXTTS.tts.utils.helpers import generate_path, maximum_path, sequence_mask
from NViXTTS.tts.utils.speakers import SpeakerManager
from NViXTTS.tts.utils.text.tokenizer import TTSTokenizer
from NViXTTS.tts.utils.visual import plot_alignment, plot_spectrogram
...
class AlignTTS(BaseTTS):
    ...
    Examples:
        >>> from NViXTTS.tts.configs.align_tts_config import AlignTTSConfig
    ...
    def get_criterion(self):
        from NViXTTS.tts.layers.losses import AlignTTSLoss  # pylint: disable=import-outside-toplevel
