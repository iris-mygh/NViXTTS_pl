...
from NViXTTS.tts.layers.feed_forward.decoder import Decoder
from NViXTTS.tts.layers.feed_forward.encoder import Encoder
from NViXTTS.tts.layers.generic.aligner import AlignmentNetwork
from NViXTTS.tts.layers.generic.pos_encoding import PositionalEncoding
...
from NViXTTS.tts.utils.helpers import average_over_durations, generate_path, maximum_path, sequence_mask
from NViXTTS.tts.utils.speakers import SpeakerManager
from NViXTTS.tts.utils.text.tokenizer import TTSTokenizer
from NViXTTS.tts.utils.visual import plot_alignment, plot_avg_energy, plot_avg_pitch, plot_spectrogram
...
class ForwardTTSArgs(Coqpit):
    ...
    Args:
        ...
        encoder_type (str):
            Type of the encoder module. One of the encoders available in :class:`NViXTTS.tts.layers.feed_forward.encoder`.
        ...
        decoder_type (str):
            Type of the decoder module. One of the decoders available in :class:`NViXTTS.tts.layers.feed_forward.decoder`.
            Defaults to `fftransformer` as in the paper.
...
class ForwardTTS(BaseTTS):
    ...
    Examples:
        >>> from NViXTTS.tts.models.fast_pitch import ForwardTTS, ForwardTTSArgs
    ...
    def get_criterion(self):
        from NViXTTS.tts.layers.losses import ForwardTTSLoss  # pylint: disable=import-outside-toplevel
