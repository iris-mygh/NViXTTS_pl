...
from NViXTTS.tts.datasets.dataset import *
from NViXTTS.tts.datasets.formatters import *
...
def load_tts_samples(
    ...
    Args:
        ...
        formatter (Callable, optional): The preprocessing function to be applied to create the list of samples. It
            ...
            `[[text, audio_path, speaker_id], ...]]`. See the available formatters in `NViXTTS.tts.dataset.formatter` as
