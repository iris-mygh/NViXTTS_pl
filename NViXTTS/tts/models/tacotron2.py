...
from NViXTTS.tts.layers.tacotron.capacitron_layers import CapacitronVAE
from NViXTTS.tts.layers.tacotron.gst_layers import GST
from NViXTTS.tts.layers.tacotron.tacotron2 import Decoder, Encoder, Postnet
from NViXTTS.tts.models.base_tacotron import BaseTacotron
from NViXTTS.tts.utils.measures import alignment_diagonal_score
...
from NViXTTS.utils.capacitron_optimizer import CapacitronOptimizer


class Tacotron2(BaseTacotron):
    """Tacotron2 model implementation inherited from :class:`NViXTTS.tts.models.base_tacotron.BaseTacotron`.
    ...
    Check :class:`NViXTTS.tts.configs.tacotron2_config.Tacotron2Config` for model arguments.
