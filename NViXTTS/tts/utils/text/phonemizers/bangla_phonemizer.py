...
from NViXTTS.tts.utils.text.bangla.phonemizer import bangla_text_to_phonemes
...
class BN_Phonemizer(BasePhonemizer):
    """🐸TTS bn phonemizer using functions in `NViXTTS.tts.utils.text.bangla.phonemizer`
