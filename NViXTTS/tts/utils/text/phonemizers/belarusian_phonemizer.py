...
from NViXTTS.tts.utils.text.belarusian.phonemizer import belarusian_text_to_phonemes
...
class BEL_Phonemizer(BasePhonemizer):
    """🐸TTS be phonemizer using functions in `NViXTTS.tts.utils.text.belarusian.phonemizer`
