...
from NViXTTS.tts.configs.shared_configs import BaseTTSConfig
from NViXTTS.tts.models.vits import VitsArgs, VitsAudioConfig
...
class VitsConfig(BaseTTSConfig):
    ...
    Note:
        Check :class:`NViXTTS.tts.configs.shared_configs.BaseTTSConfig` for the inherited parameters.
